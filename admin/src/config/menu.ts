...
export const fallbackMenuGroups = [
  ...
  },
  {
    ...
    title: '运营中心',
    children: [
      { path: '/cms', title: '内容总览', icon: 'icon-apps' },
      { path: '/cms/banner', title: '轮播', icon: 'icon-apps' },
      { path: '/cms/entry', title: '入口卡', icon: 'icon-apps' },
      { path: '/cms/showcase', title: '精选作品', icon: 'icon-apps' },
      { path: '/cms/discover', title: '官方发现', icon: 'icon-apps' },
      { path: '/cms/tool', title: '工具箱', icon: 'icon-apps' },
      { path: '/cms/skill', title: '技能精选', icon: 'icon-apps' },
      { path: '/cms/nav', title: '侧栏导航', icon: 'icon-menu' },
      { path: '/cms/brand', title: '品牌 Logo', icon: 'icon-apps' },
      { path: '/cms/notice', title: '公告', icon: 'icon-apps' },
      { path: '/discover', title: '用户发布', icon: 'icon-apps' },
    ],
  },
  {
    key: 'resource',
